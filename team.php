        ...
        <div class="col-lg-5 col-md-12 players third" id="forwards">
            ...
            <div class="playerRow">
                ...
                <div class="playerBox full threeFull">
                    <div  class="playerImage" style="background-image: url('<?php echo $filepathArr[0]?>')"></div>
                    <div class="playerUnder">1. <span>Prop</span></div>
                </div>
                <div class="playerBox empty threeEmpty"></div>
                <div class="playerBox full threeFull">
                    <div class="playerImage" style="background-image: url('<?php echo $filepathArr[1]?>')"></div>
                    <div class="playerUnder">2. <span>Hooker</span></div>
                </div>
                <div class="playerBox empty threeEmpty"></div>
                <div class="playerBox full threeFull">
                    <div class="playerImage" style="background-image: url('<?php echo $filepathArr[2]?>')"></div>
            ...
            <div class="playerRow">
                ...
                <div class="playerBox full twoFull">
                    <div class="playerImage" style="background-image: url('<?php echo $filepathArr[3]?>')"></div>
                    <div class="playerUnder">4. <span>Lock</span></div>
                </div>
                <div class="playerBox empty twoEmpty"></div>
                <div class="playerBox full">
                    <div class="playerImage" style="background-image: url('<?php echo $filepathArr[4]?>')"></div>
            ...
            <div class="playerRow">
                <div class="playerBox full threeFull">
                    <div class="playerImage" style="background-image: url('<?php echo $filepathArr[5]?>')"></div>
                    <div class="playerUnder">6. <span>Flanker</span></div>
                </div>
                <div class="playerBox empty threeEmpty"></div>
                <div class="playerBox full threeFull">
                    <div  class="playerImage" style="background-image: url('<?php echo $filepathArr[7]?>')"></div>
                    <div class="playerUnder">8. <span>No. 8</span></div>
                </div>
                <div class="playerBox empty threeEmpty"></div>
                <div class="playerBox full threeFull">
                    <div class="playerImage" style="background-image: url('<?php echo $filepathArr[6]?>')"></div>
            ...
            <div class="playerRow">
                ...
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[8]?>')" class="playerImage"></div>
                    <div class="playerUnder">9. <span>Scrum Half</span></div>
                </div>
                <div class="playerBox empty"></div>
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[9]?>')" class="playerImage"></div>
            ...
            <div class="playerRow">
                <div class="playerBox empty"></div>
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[11]?>')" class="playerImage"></div>
                    <div class="playerUnder">12. <span>Centre</span></div>
                </div>
                <div class="playerBox empty"></div>
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[12]?>')" class="playerImage"></div>
            ...
            <div class="playerRow">
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[10]?>')" class="playerImage"></div>
                    <div class="playerUnder">11. <span>Winger</span></div>
                </div>
                <div class="playerBox empty"></div>
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[14]?>')" class="playerImage"></div>
                    <div class="playerUnder">15. <span>Full Back</span></div>
                </div>
                <div class="playerBox empty"></div>
                <div class="playerBox full">
                    <div style="background-image: url('<?php echo $filepathArr[13]?>')" class="playerImage"></div>
